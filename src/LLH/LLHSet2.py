...
class LLHSet2:
    ...
    def heuristic1(self, os_ms, parameters=None):
        # print('1')
        # 随机选择两个不同机器码
        (os, ms) = os_ms
    ...
    # 随机反转工序码子序列 已测
    def heuristic2(self, os_ms, parameters=None):
        (os, ms) = os_ms
    ...
    def heuristicA(self, os_ms, parameters=None):
        (os, ms) = os_ms
        tos = os.copy()
        tms = ms.copy()
    ...
    def heuristicB(self, os_ms, parameters=None):
        (os, ms) = os_ms
        tos = os.copy()
