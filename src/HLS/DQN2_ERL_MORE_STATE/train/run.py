...
from src.HLS.DQN2_ERL_MORE_STATE.train.config import Config, build_env
from src.HLS.DQN2_ERL_MORE_STATE.train.replay_buffer import ReplayBuffer
from src.HLS.DQN2_ERL_MORE_STATE.train.evaluator import Evaluator, get_rewards_and_steps
...
def train_agent(args: Config):
    ...
    eval_env_args2 = eval_env_args.copy()
    eval_env_args2['train'] = False
    eval_env = build_env(eval_env_class, eval_env_args2, args.gpu_id)
